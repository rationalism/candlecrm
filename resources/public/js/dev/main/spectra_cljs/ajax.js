...
var rand_chsk_type_27104 = new cljs.core.Keyword(null,"auto","auto",-566279492);
var map__27102_27105 = taoensso.sente.make_channel_socket_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),rand_chsk_type_27104,new cljs.core.Keyword(null,"packer","packer",66077544),spectra_cljs.ajax.packer], null));
var map__27102_27106__$1 = ((((!((map__27102_27105 == null)))?((((map__27102_27105.cljs$lang$protocol_mask$partition0$ & (64))) || (map__27102_27105.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__27102_27105):map__27102_27105);
var chsk_27107 = cljs.core.get.call(null,map__27102_27106__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
var ch_recv_27108 = cljs.core.get.call(null,map__27102_27106__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var send_fn_27109 = cljs.core.get.call(null,map__27102_27106__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var state_27110 = cljs.core.get.call(null,map__27102_27106__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
spectra_cljs.ajax.chsk = chsk_27107;

spectra_cljs.ajax.ch_chsk = ch_recv_27108;

spectra_cljs.ajax.chsk_send_BANG_ = send_fn_27109;

spectra_cljs.ajax.chsk_state = state_27110;
...
spectra_cljs.ajax.event_msg_handler_STAR_ = (function spectra_cljs$ajax$event_msg_handler_STAR_(p__27111){
var map__27114 = p__27111;
...
var ev_msg = map__27114__$1;
var id = cljs.core.get.call(null,map__27114__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var _QMARK_data = cljs.core.get.call(null,map__27114__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var event = cljs.core.get.call(null,map__27114__$1,new cljs.core.Keyword(null,"event","event",301435442));
taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"debug","debug",-1608172596),"spectra_cljs.ajax","/tmp/form-init3288980084707781493.clj",63,new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (map__27114,map__27114__$1,ev_msg,id,_QMARK_data,event){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Event: %s",event], null);
});})(map__27114,map__27114__$1,ev_msg,id,_QMARK_data,event))
,null)),null,-1129659319);

return spectra_cljs.ajax.event_msg_handler.call(null,ev_msg);
});
cljs.core._add_method.call(null,spectra_cljs.ajax.event_msg_handler,new cljs.core.Keyword(null,"default","default",-1987822328),(function (p__27116){
...
var ev_msg = map__27117__$1;
var event = cljs.core.get.call(null,map__27117__$1,new cljs.core.Keyword(null,"event","event",301435442));
return taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"debug","debug",-1608172596),"spectra_cljs.ajax","/tmp/form-init3288980084707781493.clj",69,new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (map__27117,map__27117__$1,ev_msg,event){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Unhandled event: %s",event], null);
});})(map__27117,map__27117__$1,ev_msg,event))
,null)),null,794284918);
}));

cljs.core._add_method.call(null,spectra_cljs.ajax.event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__27119){
...
var ev_msg = map__27120__$1;
var _QMARK_data = cljs.core.get.call(null,map__27120__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var vec__27122 = (function (){var e = (function (){try{if(cljs.core.vector_QMARK_.call(null,_QMARK_data)){
return null;
} else {
return taoensso.truss.impl._dummy_error;
}
}catch (e27125){if((e27125 instanceof Error)){
var e = e27125;
return e;
} else {
throw e27125;
...
var old_state_map = cljs.core.nth.call(null,vec__27122,(0),null);
var new_state_map = cljs.core.nth.call(null,vec__27122,(1),null);
...
taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"debug","debug",-1608172596),"spectra_cljs.ajax","/tmp/form-init3288980084707781493.clj",75,new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (vec__27122,old_state_map,new_state_map,map__27120,map__27120__$1,ev_msg,_QMARK_data){
return (function (){
...
});})(vec__27122,old_state_map,new_state_map,map__27120,map__27120__$1,ev_msg,_QMARK_data))
,null)),null,956533152);

return spectra_cljs.ajax.chsk_init_BANG_.call(null);
} else {
return taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"debug","debug",-1608172596),"spectra_cljs.ajax","/tmp/form-init3288980084707781493.clj",77,new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (vec__27122,old_state_map,new_state_map,map__27120,map__27120__$1,ev_msg,_QMARK_data){
return (function (){
...
,null)),null,-1742535565);
}
}));

cljs.core._add_method.call(null,spectra_cljs.ajax.event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__27126){
...
var ev_msg = map__27127__$1;
var _QMARK_data = cljs.core.get.call(null,map__27127__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
...
return taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"debug","debug",-1608172596),"spectra_cljs.ajax","/tmp/form-init3288980084707781493.clj",83,new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (map__27127,map__27127__$1,ev_msg,_QMARK_data){
return (function (){
...
});})(map__27127,map__27127__$1,ev_msg,_QMARK_data))
,null)),null,776763406);
}
}));

cljs.core._add_method.call(null,spectra_cljs.ajax.event_msg_handler,new cljs.core.Keyword("chsk","handshake","chsk/handshake",64910686),(function (p__27129){
...
var ev_msg = map__27130__$1;
var _QMARK_data = cljs.core.get.call(null,map__27130__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var vec__27132 = _QMARK_data;
var _QMARK_uid = cljs.core.nth.call(null,vec__27132,(0),null);
var _QMARK_csrf_token = cljs.core.nth.call(null,vec__27132,(1),null);
var _QMARK_handshake_data = cljs.core.nth.call(null,vec__27132,(2),null);
return taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"debug","debug",-1608172596),"spectra_cljs.ajax","/tmp/form-init3288980084707781493.clj",88,new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (vec__27132,_QMARK_uid,_QMARK_csrf_token,_QMARK_handshake_data,map__27130,map__27130__$1,ev_msg,_QMARK_data){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Handshake: %s",_QMARK_data], null);
});})(vec__27132,_QMARK_uid,_QMARK_csrf_token,_QMARK_handshake_data,map__27130,map__27130__$1,ev_msg,_QMARK_data))
,null)),null,-1604696537);
}));
...
//# sourceMappingURL=ajax.js.map?rel=1468804319988