...
(defn tos-html []
  [:div {:class "container"}
   [:div {:class "row"}
    ...
    [:p "Agreement between user and CandleCRM"]
    ...
    [:p "https://www.candlecrm.com/ is a E-commerce Site"]

    [:p "CandleCRM provides cloud-based customer relationship management software to individuals and small businesses."]

    [:p "Privacy"]

    [:p "Your use of https://www.candlecrm.com/ is subject to CandleCRM's Privacy Policy. Please review our Privacy Policy, which also governs the Site and informs users of our data collection practices."]
    ...
    [:p "Links to third party sites/Third party services"]
    ...
    [:p "No unlawful or prohibited use/Intellectual Property"]
    ...
    [:p "Termination/access restriction"]
